/**
 * 
 * Run 'grunt' to generate JS and CSS in folder 'dist1' and site in folder '_site'
 * *
  ...
  grunt.initConfig({
    ...
    mfpbuild: {
      all: {
        ...
        basePath: 'src/js/',
        dest: 'dist1/jquery.magnific-popup.js',
        banner: '<%= banner %>'
      }
    },
    jekyll: {
    ...
    copy: {
      main: {
        files: [
          {expand:true, src: ['dist1/**'], dest: 'website/'}
        ]
      },
      dev: {
        files: [
          {expand:true, src: ['dist1/**'], dest: '_site/'}
        ]
      }
    },
    ...
    uglify: {
      my_target: {
        files: {
          'dist/jquery.magnific-popup.min.js': ['dist1/jquery.magnific-popup.js']
        },
    ...
    cssmin: {
      compress: {
        files: {
          "website/site-assets/all.min.css": ["website/site-assets/site.css", "website/dist1/magnific-popup.css"]
        }
      }
    }
